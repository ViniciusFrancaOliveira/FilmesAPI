...
namespace FilmesApi.Services
{
    public class EnderecoService
    {
        ...
        internal List<ReadEnderecoDto> RecuperaEnderecos()
        {
        ...
        internal Result AtualizaEndereco(int id, UpdateEnderecoDto enderecoDto)
        {
        ...
        internal Result AtualizaEndereco(int id)
        {
            Endereco endereco = _context.Enderecos.FirstOrDefault(endereco => endereco.Id == id);
